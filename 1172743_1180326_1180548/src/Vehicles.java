...
public class Vehicles extends JPanel {
	...
	public Vehicles() {
		...
		paneData.add(lblData);
		 ...
		 paneSearch_1.setBounds(0, 377, 268, 52);
		 ...
		 JLabel lblNumberOfVehicle = new JLabel("NUMBER OF VEHICLE");
		 lblNumberOfVehicle.setForeground(new Color(128, 0, 0));
		 lblNumberOfVehicle.setFont(new Font("Calibri", Font.BOLD, 23));
		 lblNumberOfVehicle.setBounds(54, 14, 205, 30);
		 paneSearch_1.add(lblNumberOfVehicle);
		 
		 JLabel lblsearch_1 = new JLabel("");
		 lblsearch_1.setBounds(12, 8, 32, 33);
		 paneSearch_1.add(lblsearch_1);
		 JLabel lblcalc = new JLabel(""); lblcalc.setBounds(10, 11, 32, 33); 
		 paneSearch_1.add(lblcalc);  
