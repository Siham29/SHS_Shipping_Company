...
public class deleteVehicle extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					deleteVehicle frame = new deleteVehicle();
	...
	public deleteVehicle() {
		...
		JLabel lblNewLabel_1 = new JLabel("Enter Vehicle Number you want to delete");
		lblNewLabel_1.setBounds(52, 11, 335, 20);
		...
		JButton btnNewButton = new JButton("VEHICLE TABLE ");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				veTable vetable = new veTable();
				vetable.setVisible(true);
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					connectDB();
					System.out.println("");
					String sql = "delete from vehicle where vnumber =" + Integer.parseInt(txtDELETE.getText());
					PreparedStatement st = con.prepareStatement(sql);
					int num = st.executeUpdate();
					if (num == 1)
						JOptionPane.showMessageDialog(null, "Vehicle Deleted Successfuly");
					else
						JOptionPane.showMessageDialog(null, "Invlid Vehicle ID");
