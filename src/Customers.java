	...
	public Customers() {
		...
		paneData.add(lblData);
		 ...
		 paneAdd.addMouseListener(new MouseAdapter() {
		 	...
		 	@Override
		 	public void mouseClicked(MouseEvent e) {
		 		insertCustomer cstmr = new insertCustomer();
		 ...
		 JLabel lblShippingInfo = new JLabel("NEW  CUSTOMER");
		 ...
		 JLabel lblNewOrder = new JLabel("DELETE CUSTOMER");
		 ...
		 panel.add(lblbox1);
		 Image box1 = new ImageIcon(this.getClass().getResource("/customer.png")).getImage();
		 ...
		 paneUpdate.addMouseListener(new MouseAdapter() {
		 	...
		 	@Override
		 	public void mouseClicked(MouseEvent e) {
		 		updateCustomer upsus = new updateCustomer();
		 	upsus.setVisible(true);
		 	}
		 });
		 ...
		 paneSearch.addMouseListener(new MouseAdapter() {
		 	...
		 	@Override
		 	public void mouseClicked(MouseEvent e) {
		 		searchCustomer se = new searchCustomer();
		 		se.setVisible(true);
		 	}
		 });
		 ...
		 JLabel lblSearch = new JLabel("SEARCH OF CUSTOMER");
